...
export default {
  ...
  methods: {
    getData() {
      var t = this;
      var postUrl = "/waf/waf_get_name_list_list";
      var oData = { domain: t.domain };
      if (t.ruleType == "group_rule") {
        postUrl = "/waf/waf_get_group_name_list_list";
    ...
    handleDelete(data) {
      var t = this;
      t.loading = true;
      var postUrl = "/waf/waf_del_name_list";
      var oData = {
        domain: t.domain,
        name_list_uuid: data.name_list_uuid
      };
      if (t.ruleType == "group_rule") {
        postUrl = "/waf/waf_del_group_name_list";
        oData = {
          group_id: t.domain,
          name_list_uuid: data.name_list_uuid
        };
    ...
    onClickChangeOrderSubmit(index, value, operate) { 
      ...
      var postUrl = "/waf/waf_exchange_name_list_priority";

      if (t.ruleType == "group_rule") {
        postUrl = "/waf/waf_exchange_group_name_list_priority";
        oData.group_id = t.domain;
      } else {
    ...
    onChangeRuleStatus(value) { 
      ...
      var postUrl = "/waf/waf_edit_name_list";
      if (t.ruleType == "group_rule") {
        postUrl = "/waf/waf_edit_group_name_list";
        oData = {
          group_id: t.domain,
          name_list_uuid: value.name_list_uuid,
          status: value.status
