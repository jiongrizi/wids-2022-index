...
export default {
  ...
  methods: {
    getData() {
      var t = this;
      var postUrl = "/waf/waf_get_flow_white_rule_list";
      var oData = { domain: t.domain };
      if (t.ruleType == "group_rule") {
        postUrl = "/waf/waf_get_group_flow_white_rule_list";
    ...
    onClickDownloadRuleSubmit(downloadRuleForm) { 
      var t = this;
      var postUrl = "/waf/waf_load_flow_white_rule";
      var oData = {};
      if (t.ruleType == "single_rule") {
        ...
        postUrl = "/waf/waf_load_group_flow_white_rule";
    ...
    handleDelete(data) {
      var t = this;
      t.loading = true;
      var postUrl = "/waf/waf_del_flow_white_rule";
      var oData = {
        domain: t.domain,
        rule_uuid: data.rule_uuid
      };
      if (t.ruleType == "group_rule") {
        postUrl = "/waf/waf_del_group_flow_white_rule";
        oData = {
          group_id: t.domain,
          rule_uuid: data.rule_uuid
        };
    ...
    onClickChangeOrderSubmit(index, value, operate) { 
      ...
      var postUrl = "/waf/waf_exchange_flow_white_rule_priority";

      if (t.ruleType == "group_rule") {
        postUrl = "/waf/waf_exchange_group_flow_white_rule_priority";
        oData.group_id = t.domain;
      } else { 
    ...
    onChangeRuleStatus(value) { 
      ...
      var postUrl = "/waf/waf_edit_flow_white_rule";
      if (t.ruleType == "group_rule") {
        postUrl = "/waf/waf_edit_group_flow_white_rule";
        oData = {
          group_id: t.domain,
          rule_uuid: value.rule_uuid,
          rule_status: value.rule_status
